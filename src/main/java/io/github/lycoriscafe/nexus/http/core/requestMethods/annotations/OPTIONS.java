...
/**
 * Mark endpoint method as an HTTP {@code OPTIONS} request method endpoint. There are few points that API users should follow.
 * <ul>
 ...
 *     <li>Annotated method must have 2 parameters. {@code HttpOptionsRequest} and {@code HttpResponse} respectively.</li>
