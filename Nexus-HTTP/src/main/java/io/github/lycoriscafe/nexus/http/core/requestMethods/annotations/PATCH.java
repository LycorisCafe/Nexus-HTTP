...
/**
 * Mark endpoint method as an HTTP {@code PATCH} request method endpoint. There are few points that API users should follow.
 * <ul>
 ...
 *     <li>Annotated method must have 2 parameters. {@code HttpPatchRequest} and {@code HttpResponse} respectively.</li>
